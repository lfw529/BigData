...
public class YarnClusterDescriptor implements ClusterDescriptor<ApplicationId> {
    ...
    public ClusterClientProvider<ApplicationId> deployApplicationCluster(
        ...
        try {
            //TODO 部署 flink yarn application 集群
            return deployInternal(
                    clusterSpecification,
    ...
    public ClusterClientProvider<ApplicationId> deployJobCluster(
        ...
        try {
            return deployInternal(
                    ...
                    getYarnJobClusterEntrypoint(),  //TODO 获取YarnJobClusterEntrypoint，启动AM的入口
                    jobGraph,
                    detached);
        } catch (Exception e) {
    ...
    private ApplicationReport startAppMaster(
        ...
        if (providedLibDirs == null || providedLibDirs.isEmpty()) {
            ...
            //TODO => shipOnlyFiles：plugins/目录下的文件
            fileUploader.registerMultipleLocalResources(
        ...
        if (jobGraph != null) {
            ...
            try {
                ...
                //TODO 将JobGraph写入tmp文件并添加到本地资源，并上传到HDFS
