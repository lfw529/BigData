 ...
 */
package com.lfw.operator.sink.avro.schema;
...
public class AvroEventLogBean extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = -977339657603564082L;
  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"AvroEventLogBean\",\"namespace\":\"com.lfw.operator.sink.avro.schema\",\"fields\":[{\"name\":\"guid\",\"type\":\"long\"},{\"name\":\"sessionId\",\"type\":\"string\"},{\"name\":\"eventId\",\"type\":\"string\"},{\"name\":\"timeStamp\",\"type\":\"long\"},{\"name\":\"eventInfo\",\"type\":{\"type\":\"map\",\"values\":\"string\"}}]}");
  ...
  @Deprecated public long guid;
  @Deprecated public java.lang.CharSequence sessionId;
  @Deprecated public java.lang.CharSequence eventId;
  @Deprecated public long timeStamp;
  @Deprecated public java.util.Map<java.lang.CharSequence,java.lang.CharSequence> eventInfo;
   ...
   */
  public void setGuid(java.lang.Long value) {
    this.guid = value;
  }
   ...
   */
  public static com.lfw.operator.sink.avro.schema.AvroEventLogBean.Builder newBuilder() {
    return new com.lfw.operator.sink.avro.schema.AvroEventLogBean.Builder();
  }
   ...
   * @return A new AvroEventLogBean RecordBuilder
   */
  public static com.lfw.operator.sink.avro.schema.AvroEventLogBean.Builder newBuilder(com.lfw.operator.sink.avro.schema.AvroEventLogBean.Builder other) {
    return new com.lfw.operator.sink.avro.schema.AvroEventLogBean.Builder(other);
  }
   ...
   * @return A new AvroEventLogBean RecordBuilder
   */
  public static com.lfw.operator.sink.avro.schema.AvroEventLogBean.Builder newBuilder(com.lfw.operator.sink.avro.schema.AvroEventLogBean other) {
    return new com.lfw.operator.sink.avro.schema.AvroEventLogBean.Builder(other);
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<AvroEventLogBean>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(com.lfw.operator.sink.avro.schema.AvroEventLogBean.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(com.lfw.operator.sink.avro.schema.AvroEventLogBean other) {
            super(SCHEMA$);
      if (isValidValue(fields()[0], other.guid)) {
        this.guid = data().deepCopy(fields()[0].schema(), other.guid);
        fieldSetFlags()[0] = true;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.lfw.operator.sink.avro.schema.AvroEventLogBean.Builder setGuid(long value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.lfw.operator.sink.avro.schema.AvroEventLogBean.Builder clearGuid() {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.lfw.operator.sink.avro.schema.AvroEventLogBean.Builder setSessionId(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.lfw.operator.sink.avro.schema.AvroEventLogBean.Builder clearSessionId() {
      sessionId = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.lfw.operator.sink.avro.schema.AvroEventLogBean.Builder setEventId(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.lfw.operator.sink.avro.schema.AvroEventLogBean.Builder clearEventId() {
      eventId = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.lfw.operator.sink.avro.schema.AvroEventLogBean.Builder setTimeStamp(long value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.lfw.operator.sink.avro.schema.AvroEventLogBean.Builder clearTimeStamp() {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.lfw.operator.sink.avro.schema.AvroEventLogBean.Builder setEventInfo(java.util.Map<java.lang.CharSequence,java.lang.CharSequence> value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.lfw.operator.sink.avro.schema.AvroEventLogBean.Builder clearEventInfo() {
      eventInfo = null;
