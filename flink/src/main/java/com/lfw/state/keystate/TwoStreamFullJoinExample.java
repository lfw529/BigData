package com.lfw.state.keystate;
    ...
    public static void main(String[] args) throws Exception {
        ...
        stream1.keyBy(r -> r.f0)
                ...
                .process(new CoProcessFunction<Tuple3<String, String, Long>, Tuple3<String, String, Long>, Object>() {
                    ...
                    @Override
                    public void processElement1(Tuple3<String, String, Long> left, Context ctx, Collector<Object> collector) throws Exception {
                    ...
                    @Override
                    public void processElement2(Tuple3<String, String, Long> right, Context ctx, Collector<Object> collector) throws Exception {
