...
public class NFAExample {
    ...
    public static class StateMachineMapper extends RichFlatMapFunction<LoginCEP, String> {
        ...
        @Override
        public void flatMap(LoginCEP event, Collector<String> out) throws Exception {
            //获取状态，如果状态为空，置为初始状态
