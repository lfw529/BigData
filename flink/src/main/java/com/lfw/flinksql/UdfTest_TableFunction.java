...
public class UdfTest_TableFunction {
    public static void main(String[] args) {
        ...
        //4.调用UDF查询转换
        Table resultTable = tableEnv.sqlQuery("select user, url, word, length " + "from EventTable, LATERAL TABLE( MySplit(url) ) AS T(word, length)");
    ...
    //自定义一个 TableFunction，注意有泛型，这里输出的是两个字段，二元组 [url问号 前后长度]
