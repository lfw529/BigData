...
import com.lfw.pojo.AdCount;
import com.lfw.pojo.AdsClickLog;
...
public class AdClickCount {
    public static void main(String[] args) throws Exception {
        ...
        SingleOutputStreamOperator<AdsClickLog> adsClickLogDS = env.readTextFile("flink/src/main/resources/AdClickLog.csv")
                .map(data -> {
