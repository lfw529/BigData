...
import com.lfw.pojo.OrderEvent;
...
public class OrderReceiptWithState {
    public static void main(String[] args) throws Exception {
        ...
        //2.读取2个文本数据创建流
        DataStreamSource<String> orderStreamDS = env.readTextFile("flink/src/main/resources/OrderLog.csv");
        DataStreamSource<String> receiptStreamDS = env.readTextFile("flink/src/main/resources/ReceiptLog.csv");
