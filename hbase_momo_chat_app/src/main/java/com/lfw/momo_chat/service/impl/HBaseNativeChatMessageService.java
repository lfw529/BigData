    ...
    public List<Msg> getMessage(String date, String sender, String receiver) throws Exception {
        ...
        while (iterator.hasNext()) {
            ...
            for (Cell cell : cellList) {
                ...
                if (columnName.equals("sender_nickname")) {
                    msg.setSender_nickname(Bytes.toString(cell.getValueArray(), cell.getValueOffset(), cell.getValueLength()));
                }
                ...
                if (columnName.equals("receiver_nickname")) {
                    msg.setReceiver_nickname(Bytes.toString(cell.getValueArray(), cell.getValueOffset(), cell.getValueLength()));
                }
