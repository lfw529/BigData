package com.lfw.momo_chat.tool;
...
public class MoMoMsgGen {
    public static void main(String[] args) throws ParseException, IOException {
        // 读取Excel文件中的数据
        String xlsxPath = new File("").getCanonicalPath() + "/hbase_momo_chat_app/datas/测试数据集.xlsx";
        Map<String, List<String>> resultMap = ExcelReader.readXlsx(xlsxPath, "陌陌数据");

        //打印1
//        Msg msg = getOneMessage(resultMap);
//        System.out.println(getRowkey(msg));
        ...
        while (i < MAX) {
            ...
            String colSender_nickname = "sender_nickname";
            ...
            String colReceiver_nickname = "receiver_nickname";
            ...
            put.addColumn(Bytes.toBytes(cf), Bytes.toBytes(colSender_nickname), Bytes.toBytes(msg.getSender_nickname()));
            ...
            put.addColumn(Bytes.toBytes(cf), Bytes.toBytes(colReceiver_nickname), Bytes.toBytes(msg.getReceiver_nickname()));
    ...
    public static Msg getOneMessage(Map<String, List<String>> resultMap) {
        ...
        // 初始化sender_nickname字段，调用randomColumn随机取nick_name设置数据
        msg.setSender_nickname(ExcelReader.randomColumn(resultMap, "sender_nickname"));
        ...
        msg.setReceiver_nickname(ExcelReader.randomColumn(resultMap, "receiver_nickname"));
