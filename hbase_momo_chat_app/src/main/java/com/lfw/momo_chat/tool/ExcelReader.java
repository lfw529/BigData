...
public class ExcelReader {
    ...
    public static void main(String[] args) {
        try {
            ...
            Map<String, List<String>> mapData = readXlsx(xlsxPath, "陌陌数据");

            for (int i = 0; i < 10000; ++i) {
                System.out.println(randomColumn(mapData, "sender_nickname"));
            }
        } catch (IOException e) {
            e.printStackTrace();
        }
    ...
    public static String randomColumn(Map<String, List<String>> resultMap, String columnName) {
        ...
        if (valList == null)
            throw new RuntimeException("未取到列名为" + columnName + "的任何数据！");
